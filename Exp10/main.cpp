...
void C1_str(char *,char , char , char );                    //Circuit 1 Structural
void C1_beh(char *,char , char , char );                    //Circuit 1 Behavioural
void C2_str(char *,char , char , char );                    //Circuit 2 Structural
void C2_beh(char *,char , char , char );                    //Circuit 2 Behavioural
void C3_str(char *,char , char , char, char );         //Circuit 3 Structural
void C3_beh(char *,char , char , char, char );         //Circuit 3 Behavioural

char a,b,c,d,out;          //Global Variables (To Be Used By Functions)
